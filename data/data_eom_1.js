    ...
    const data = {
        ...
        "index_1":{
            ...
            "paragraph_2":[
                ...
                <p class="math_equation">$$ \\frac{F_1}{F_2} = \\frac{CB}{AC} .$$</sp><br>
            ...
            "paragraph_4":[
                ...
                <p>При этом на основании теоремы Вариньона получаем соотношения</p>
                <p><span class="math_equation">$ M_C(\\vec{F_1}) + M_C(\\vec{F_2}) = F_1 \\cdot AC - F_2 \\cdot CB = 0.$</span>
                </p>
                <p>
        ...
        "index_2":{
            ...
            "paragraph_2":[
                {"text": `<p>
                    <span class="math_equation">Определим равнодействующую сил $ \\vec{F}_{1-2} $ и $ \\vec{F_3} $. Равнодействующая $ \\vec{R} $ двух сонаправленных параллельных сил $ \\vec{F}_{1-2} $ и $ \\vec{F_3} $ равна по величине их сумме, а её линия действия делит отрезок, соединяющий точки приложения этих сил обратно пропорционально их величинам внутренним образом. Точка C − точка приложения равнодействующей этих двух сил.</span>
                    </p>
        ...
        "index_3":{
            ...
            "paragraph_2":[
                {"text":`
                    ...
                    или 
                    <span class="math_equation math_equation_custom">$ z_C = \\frac{\\sum F_k \\cdot z_k}{\\sum F_k} $</span>.
                    </p>
        ...
        "index_4":{
            ...
            "paragraph_2":[
                ...
                {"text": `
                     <p>
                    <span class="math_equation math_equation_custom">$ x_C = \\frac{\\sum G_k \\cdot x_k}{\\sum G_k} $</span>; 
                    <span class="math_equation math_equation_custom">$ y_C = \\frac{\\sum G_k \\cdot y_k}{\\sum G_k} $</span>; 
                    <span class="math_equation math_equation_custom">$ z_C = \\frac{\\sum G_k \\cdot z_k}{\\sum G_k} $</span>,
                    </p>
                    <p>
        ...
        "index_5":{
            ...
            "paragraph_1":[
                ...
                {"text":`<p>
                    <b class='blue_header'>1.</b> Для объемных однородных тел вес каждой частицы тела определяется как <br>
                    <span class="math_equation">$$ G_k = V_k \\cdot \\gamma,$$</span>
                    где <span class="math_equation">$ V_k $</span> − объем частицы тела; <br>
                    ...
                    <p>
                    <span class="math_equation math_equation_custom">$ x_C = \\frac{\\sum V_k \\cdot x_k}{\\sum V_k} = \\frac{\\sum \\gamma \\cdot V_k \\cdot x_k}{\\sum \\gamma \\cdot V_k} = \\frac{\\gamma \\cdot \\sum V_k \\cdot x_k}{\\gamma \\cdot \\sum V_k} = \\frac{\\sum V_k \\cdot x_k}{\\sum V_k} $</span>.
                    </p>

                    <p>
                    Аналогично для координат <span class="math_equation math_equation_custom"> $ y_C $ и $ z_C $ </span>:
                    </p>
                    <p>
            ...
            "paragraph_3":[
                {"text":`<p>
                    ...
                    <p>
                    <span class="math_equation math_equation_custom">$ x_C = \\frac{\\sum G_k \\cdot x_k}{\\sum G_k} = \\frac{\\sum \\gamma_L \\cdot l_k \\cdot x_k}{\\sum \\gamma_L \\cdot l_k} = \\frac{\\gamma_L \\cdot \\sum l_k \\cdot x_k}{\\gamma_L \\cdot \\sum l_k} = \\frac{\\sum l_k \\cdot x_k}{\\sum l_k} $</span>.
                    </p>
                    <p>
            ...
            "paragraph_4":[
                ...
                {"text":`<p>
                    ...
                    <p>
                    <span class="math_equation math_equation_custom">$ x_C = \\frac{\\sum G_k \\cdot x_k}{\\sum G_k} = \\frac{\\sum \\gamma_A \\cdot A_k \\cdot x_k}{\\sum \\gamma_A \\cdot A_k} = \\frac{\\gamma_A \\cdot \\sum A_k \\cdot x_k}{\\gamma_A \\cdot \\sum A_k} = \\frac{\\sum A_k \\cdot x_k}{\\sum A_k} $</span>.
                    </p>
                    <p>
                    Аналогично для координаты <span class="math_equation math_equation_custom"> $ y_C $ </span>:
                    </p>
                    <p>
                    <span class="math_equation math_equation_custom">$ y_C = \\frac{\\sum A_k \\cdot y_k}{\\sum A_k} $</span>.
                    </p>
                        `}
            ]
        },
        ...
        "index_8":{
            ...
            "paragraph_6":[
                ...
                {"text":`
                    <p> 
                    Еще один из возможных способов практического определения центра тяжести является <b> метод взвешивания. </b></p>
                    <p>
                    Этот метод применяется для определения центра тяжести крупных машин, самолетов и изделий. Для этого нужны весы, способные выдерживать вес машины (например, платформенные весы для автомобилей).
                    </p>`}
            ],
            "paragraph_7":[
                {"image": true, "image_path": "./content/page_content/img9_3.png", "img_sign": " "},
                {"text":`
                    <p> 
                    Необходимо определить две опорные точки на машине. Чаще всего опорными точками служат передние и задние колеса. Эти точки будут служить опорой для взвешивания.
                    </p>
                    <p>
                    Одна из опорных точек устанавливается на весы и измеряется масса этой опоры. На изображении в качестве опорной точки выбран передний мост автомобиля. Данные, полученные с весов, фактически отражают реакцию опоры, которая применяется при составлении уравнения равновесия в отношении второй опоры (которая находится вне весового устройства).
                    </p>`}
            ],
            "paragraph_8":[
                {"text":`
